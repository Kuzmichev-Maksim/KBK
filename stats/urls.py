...
urlpatterns = [
    ...
    path('phone_history/<int:phone_id>/',
         phone_history_view, name='phone_history'),
    path('metrics/', csrf_exempt(exports.ExportToDjangoView),
         name='prometheus-django-metrics'),
    path('metrics', csrf_exempt(exports.ExportToDjangoView),
         name='prometheus-django-metrics-no-slash'),
